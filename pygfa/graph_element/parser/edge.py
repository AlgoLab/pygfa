...
class Edge(line.Line):
    ...
    def from_string(cls, string: str) -> "Edge":
        ...
        :param string: The input string containing edge data.
        :return: An Edge instance parsed from the string.
        ...
        if len(fields) < len(cls.REQUIRED_FIELDS):
            raise line.InvalidLineError(
                "The minimum number of field for " + "Edge line is not reached."
            )
