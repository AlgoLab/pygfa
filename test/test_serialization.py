...
class TestLine(unittest.TestCase):
    ...
    def test_serialize_gfa1_node(self):
        ...
        self.graph.add_node(node_)
        node2 = node.Node.from_line(segment.SegmentV1.from_string("S\t2\t*"))
    ...
    def test_serialize_gfa1_edge(self):
        ...
        containment_ = ge.Edge.from_line(
            containment.Containment.from_string("C\t1\t+\t5\t+\t12\t120M\tID:Z:1_to_5\txx:Z:test")
        )
        ...
        self.assertTrue(
            gs1.serialize_edge(self.graph.edges(identifier="1_to_3"), "1_to_3")
            == "L\t1\t+\t3\t+\t12M\tID:Z:1_to_3\txx:Z:test"
        )
        self.assertTrue(
            gs1.serialize_edge(self.graph.edges(identifier="1_to_5"), "1_to_5")
        ...
        self.assertTrue(
            gs1.serialize_edge(self.graph.edges(identifier="virtual_1"), "virtual_1")
    ...
    def test_serialize_gfa1_subgraph(self):
        ...
        self.assertTrue(
            gs1.serialize_subgraph(self.graph.subgraphs("15").as_dict(), "graph -> path id:15")
            == "P\t15\t11+,13+\t120M"
        )
        ...
        self.assertTrue(
            gs1.serialize_subgraph(self.graph.subgraphs("15").as_dict(), "graph -> ogroup id:15")
    ...
    def test_serialize_gfa2_node(self):
        self.graph.clear()
        node_ = node.Node.from_line(segment.SegmentV1.from_string("S\t1\tACGT\tLN:i:42\txx:Z:test"))
        node_v2 = node.Node.from_line(segment.SegmentV2.from_string("S\t1\t122\t*\txx:Z:test"))
        self.assertTrue(gs2.serialize_node(node_) == "S\t1\t42\tACGT\txx:Z:test")
        self.assertTrue(gs2.serialize_node(node_v2) == "S\t1\t122\t*\txx:Z:test")

        self.graph.add_node(node_)

        self.assertTrue(
            gs2.serialize_node(self.graph.nodes(identifier="1"), "gfa2_node 1 from SegmentV1")
        ...
        self.assertTrue(
            gs2.serialize_node(self.graph.nodes(identifier="1"), "gfa2_node 1 from SegmentV2")
            == "S\t1\t122\t*\txx:Z:test"
        )
        self.graph.remove_node("1")
        ...
        node_ = node.Node.from_line(segment.SegmentV1.from_string("S\t1\tACGT"))
        self.graph.add_node(node_)
        self.assertTrue(gs2.serialize_node(node_, "gfa2 node 1 without length") == "S\t1\t4\tACGT")

        node_ = node.Node.from_line(segment.SegmentV1.from_string("S\t2\tACGT\tLN:i:42\txx:Z:test"))
        self.graph.add_node(node_)
        self.assertTrue(
            gs2.serialize_node(self.graph.nodes(identifier="2"), "gfa2 node 2 with length")
    ...
    def test_serialize_gfa2_edge(self):
        ...
        self.assertTrue(gs2.serialize_edge(link_without_id, "gfa2 link2") == "")
        self.assertTrue(gs2.serialize_edge(containment_, "gfa2 containment") == "")
        self.assertTrue(gs2.serialize_edge(containment_with_trace, "gfa2 containment") == "")
        ...
        self.assertTrue(
            gs2.serialize_edge(self.graph.edges(identifier="2_to_6"), "gfa2 edge: 2_to_6")
            == "E\t2_to_6\t2+\t6+\t0\t122$\t10\t132\t42,42,42\txx:Z:test"
        )
        self.assertTrue(
            gs2.serialize_edge(self.graph.edges(identifier="2_to_12"), "gfa2 gap: 2_to_12")
    ...
    def test_serialize_gfa2_subgraph(self):
        ...
        self.graph.add_subgraph("O\t15\t11+ 11_to_13+ 13+\txx:i:-1")
        self.assertTrue(
            gs2.serialize_subgraph(self.graph.subgraphs("15").as_dict(), "graph -> ogroup id:15")
            == "O\t15\t11+ 11_to_13+ 13+\txx:i:-1"
        )
        self.graph.remove_subgraph("15")
        ...
        self.graph.add_subgraph("U\t16\t11 13 11_to_13 16sub")
        self.assertTrue(
            gs2.serialize_subgraph(self.graph.subgraphs("16").as_dict(), "graph -> ugroup id:16")
            == "U\t16\t11 13 11_to_13 16sub"
        )
        self.graph.remove_subgraph("16")
    ...
    def test_serialize_gfa2_graph(self):
        ...
        self.assertTrue(another_equal_graph.subgraphs() == same_graph.subgraphs())
