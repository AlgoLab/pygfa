#!/usr/bin/env python3
"""Round-trip tests (small tier): files requiring at most 4 GB memory.

Tests that converting a GFA file to BGFA and back produces an identical GFA.
Only runs on GFA files tagged with `# benchmark: roundtrip_small`.
"""
...
BENCHMARK_NAME = "roundtrip_small"
