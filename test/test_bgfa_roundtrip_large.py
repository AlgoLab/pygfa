...
BENCHMARK_NAME = "roundtrip_large"
...
def pytest_collection_modifyitems(items):
    """Group all large-tier tests so at most one runs at a time with pytest-xdist."""
    marker = pytest.mark.xdist_group("roundtrip_large")
    for item in items:
