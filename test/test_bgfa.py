...
@pytest.mark.parametrize("int_encoding,str_encoding", ALL_ENCODING_COMBINATIONS)
...
def test_bgfa_idempotent_1(int_encoding, str_encoding):
    ...
    test_gfa_to_bgfa_to_gfa_regression("data/example_1.gfa", int_encoding, str_encoding)


@pytest.mark.parametrize("int_encoding,str_encoding", ALL_ENCODING_COMBINATIONS)
def test_bgfa_idempotent_2(int_encoding, str_encoding):
    """Test that pprint output matches expected file content with all encoding strategies."""
    test_gfa_to_bgfa_to_gfa_regression("data/example_2.gfa", int_encoding, str_encoding)


@pytest.mark.parametrize("int_encoding,str_encoding", ALL_ENCODING_COMBINATIONS)
def test_bgfa_idempotent_3(int_encoding, str_encoding):
    """Test that pprint output matches expected file content with all encoding strategies."""
    test_gfa_to_bgfa_to_gfa_regression("data/example_3.gfa", int_encoding, str_encoding)
